(ns lotus.utils.autocompleter.utils.reactive
  ...
  (:require [goog.events :as events]
            ...
            [lotus.utils.autocompleter.utils.helpers :refer [index-of now]]
            [lotus.utils.autocompleter.utils.dom :as dom])
  (:require-macros [cljs.core.async.macros :refer [go alt!]]
                   [lotus.utils.autocompleter.utils.macros :refer [dochan]])
